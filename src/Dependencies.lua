...
require 'src/states/entity/player/PlayerLiftedWalkState'
require 'src/states/entity/player/PlayerLiftedIdleState'
...
gTextures = {
    ...
    ['character-lifted-walk'] = love.graphics.newImage('graphics/character_pot_walk.png'),
...
gFrames = {
    ...
    ['character-lifted-walk'] = GenerateQuads(gTextures['character-lifted-walk'], 16, 32),
